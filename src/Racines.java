...
{ final int NFOIS = 5 ; //le mot clé final précise que la veleur de la variable correspondante ne peut être modifiée au cours de l'exécution
    // NFOIS est une constante symbolique dans de nombreux langages
    int i ;
    double x ;
    double racx ;
